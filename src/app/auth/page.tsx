  ...
  return (
    <div className="relative flex h-screen w-full overflow-hidden bg-black">
      <div className="absolute inset-0 z-0 md:relative md:inset-auto md:w-1/2 md:shrink-0">
        ...
        <div className="absolute inset-0 hidden md:flex items-start justify-start p-10">
          <Image
            src="/logo.png"
            alt="Trainify Logo"
            width={120}
      ...
      <div
        className={cn(
          "relative z-10 mt-auto flex w-full flex-col items-center gap-16 rounded-t-3xl px-5 pt-12 pb-10 bg-primary",
          "md:mt-0 md:w-1/2 md:rounded-none md:justify-center md:gap-12 md:px-16 md:py-0",
        )}
      >
        <div className="relative z-10 flex size-32 items-center justify-center md:hidden">
          <Image
            src="/logo.png"
            alt="Trainify Logo"
            width={130}
        ...
        <div className="flex flex-col items-center gap-6 text-center md:items-start md:text-left">
          <h1 className="font-tight text-3xl leading-tight font-semibold text-white md:text-4xl lg:text-5xl">
